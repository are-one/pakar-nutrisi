        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                ...
                <div class="container-items">
                    ...
                    <?php
                    foreach ($modelPenangananPenyakits as $index => $penangananPenyakit) :
                        ...
                        <div class="item container-fluid">
                            ...
                            <div class="widget-box span">
                                ...
                                <div class="widget-content ">
                                    ...
                                    // if (!$penangananPenyakit->isNewRecord) {
                                    // echo Html::activeHiddenInput($penangananPenyakit, "[{$index}]id_penyakit", ['value' => $id_penyakit]);
                                    // }

                                    ?>

                                    <?= $form->field($penangananPenyakit, "[{$index}]id_penanganan", [
                                        'template' => '
                                                                {label}
                                                                <div class="controls">
                                                                    {input}
                                    ...
                                    ])->dropDownList(ArrayHelper::map($listPenanganan, 'id_penanganan', 'penanganan'), [
                                        'class' => 'span10',
                                        'prompt' => [
                                    ...
                                    ])->label($penangananPenyakit->getAttributeLabel('id_penanganan') . ' : ', [
                                        'class' => 'control-label'
                                    ]) ?>
                                </div>
